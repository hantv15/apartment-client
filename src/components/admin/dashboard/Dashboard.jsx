                ...
                <div className="d-flex m-b-30 align-items-center no-block">
                  ...
                  <div className="ml-auto">
                    <ul className="list-inline font-12">
                      <li>
                        <i className="fa fa-circle text-info" /> Iphone
                      </li>
                      <li>
                        <i className="fa fa-circle text-primary" /> Ipad
                      </li>
                    </ul>
                  </div>
                </div>
              ...
              <div className="card-body bg-light">
                <div className="row text-center m-b-20">
                  <div className="col-lg-4 col-md-4 m-t-20">
                    <h2 className="m-b-0 font-light">6000</h2>
                    <span className="text-muted">Total sale</span>
                  </div>
                  <div className="col-lg-4 col-md-4 m-t-20">
                    <h2 className="m-b-0 font-light">4000</h2>
                    <span className="text-muted">Iphone</span>
                  </div>
                  <div className="col-lg-4 col-md-4 m-t-20">
                    <h2 className="m-b-0 font-light">2000</h2>
                    <span className="text-muted">Ipad</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="card-body">
                ...
                <div className="steamline m-t-40">
                  ...
                  <div className="sl-item">
                    ...
                    <div className="sl-right">
                      <div className="font-medium">
                        John Doe <span className="sl-date"> 5pm</span>
                      </div>
                    ...
                    <div className="sl-right">
                      ...
                      <div className="desc">
                        ...
                        <a
                          ...
                          className="btn m-t-10 m-r-5 btn-rounded btn-outline-success"
                        >
                          Apporve
                        </a>
                        <a
                          href="javascript:void(0)"
                          className="btn m-t-10 btn-rounded btn-outline-danger"
                        >
                          Refuse
                        </a>
                      </div>
            ...
            <div className="card">
              ...
              <ul className="feeds p-b-20">
                ...
                <li>
                  ...
                  New order received.
                  <span className="text-muted">31 May</span>
                </li>
                <li>
                  ...
                  New user registered.
                  <span className="text-muted">30 May</span>
                </li>
                <li>
